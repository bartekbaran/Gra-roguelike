...
public class Sprite {
    ...
    public Sprite(String file) {
        ...
        System.out.println("Loading textures: " + file + "...");
    ...
    public BufferedImage[] getSpirteArray(int i) {
    ...
    public static void drawTile(Graphics2D g, Tiles t, int i, Vector2f pos, int width, int height, int xOffset, int yOffset) {
        float x = pos.x;
        float y = pos.y;

        g.drawImage(t.getCoordinates(i), (int) x, (int) y, width, height, null);
    }
